...
\linebreak
\textbf{For Tool in class T3, we recommend to develop them according to the requirements described in annex \ref{annexB}.}\\ 
\hline
...
\end{itemize}
NOTE: \linebreak
The traceability of requirements at this stage back to \ref{req-pha} is mandatory. 
