...
\begin{comment}
MPD : Identification of Vital and non vital  can be donne only if the safety  analysers have provided safety properties and have allocated them to  functions.
\end{comment}
