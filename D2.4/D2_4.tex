...
\begin{issue}
Is the detailed description of the formal methods to used during the openETCS project necessary ?
If yes, can we postpone the final version of the document after the choice of the methods ? How the document can then be compatible with the deliverable of WP7 ?
