...
\item \emph{Sequence Diagram} \sysmlicon{SequenceDiagram.png} : Specification on sequence of functions, timing constraints, Test case, execution trace, counter
  example, etc.
...
\item Duration Observation Symbol   \sysmlicon{DurationObservation.png}
\item Duration Constraint Symbol  \sysmlicon{DurationConstraint.png}
\item Time Observation Symbol  \sysmlicon{TimeObservation.png}
\item Time Constraint Symbol  \sysmlicon{TimeConstraint.png}
\end{itemize}
